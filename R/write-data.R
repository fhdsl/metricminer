...
#' @description This is a function to write metricminer data to a Googlesheet. Scopes used for this function is the `See, edit, create, and delete only the specific Google Drive files you use with this app.` when you get to the OAuth consent screen. If you do not check this box, this function won't work.
