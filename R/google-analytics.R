...
#'  The scopes it uses is the `See and download your Google Analytics data` and `View and manage your Google Analytics data` If you don't check these boxes on the OAuth screen this won't work.
...
#' this user has access to.  The scopes it uses is the `See and download your Google Analytics data` and `View and manage your Google Analytics data` If you don't check these boxes on the OAuth screen this won't work.
#' @param request_type Is this a GET or a POST?
#' @param token credentials for access to Google using OAuth.  `authorize("google")`
#' @importFrom httr config accept_json content
#' @importFrom jsonlite fromJSON
...
#' @description  The scopes it uses is the `See and download your Google Analytics data` and `View and manage your Google Analytics data` If you don't check these boxes on the OAuth screen this won't work.
...
#' @description This is a function to gets metrics and dimensions for all properties associated with an account. The scopes it uses is the `See and download your Google Analytics data` and `View and manage your Google Analytics data` If you don't check these boxes on the OAuth screen this won't work.
